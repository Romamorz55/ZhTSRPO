...
public class Snaryad_for2_2 : MonoBehaviour
{
    ...
    void Start()
    {
        _obsh_Perem = GameObject.Find("___obsch_obect2");
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.transform.tag == "Enemy_Tank")
        {
            ...
            _obsh_Perem.GetComponent<Klass_Obshih_Peremennih_1>().Zvuk_Razrusheniya_tanka();
            Destroy(gameObject);
        }
