...
/*
    ...
    {
        bashnya_tanka.transform.localEulerAngles = new Vector3(0, _obsh_Perem.GetComponent<Klass_Obshih_Peremennih_2>().ugol_horizont_Pushki);
        pushka_Fiktivnaya_tanka.transform.localEulerAngles = new Vector3(_obsh_Perem.GetComponent<Klass_Obshih_Peremennih_2>().ugol_vert_Pushki, 0);
    ...
    private void Proverka_na_Vistrel()
    {
        ...
        if (schetchik_vremya_mejdu_Vestrelami >= _obsh_Perem.GetComponent<Klass_Obshih_Peremennih_2>().vremya_mejdu_Vestrelami)
        {
