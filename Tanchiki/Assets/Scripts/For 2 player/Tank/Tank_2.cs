...
public class Tank__2 : MonoBehaviour
{
    ...
    void Start()
    {
        _obsh_Perem = GameObject.Find("___obsch_obect_2");
   ...
   /* private void Povorot_Bashni_i_Pushki()
    {
        bashnya_tanka.transform.localEulerAngles = new Vector3(0, _obsh_Perem.GetComponent<Klass_Obshih_Peremennih_1>().ugol_horizont_Pushki_1);
        pushka_Fiktivnaya_tanka.transform.localEulerAngles = new Vector3(_obsh_Perem.GetComponent<Klass_Obshih_Peremennih_1>().ugol_vert_Pushki_1, 0);
    ...
    private void Proverka_na_Vistrel()
    {
        ...
        if (schetchik_vremya_mejdu_Vestrelami >= _obsh_Perem.GetComponent<Klass_Obshih_Peremennih_1>().vremya_mejdu_Vestrelami_1)
        {
